...
#sample----
SRP472645_CpG_meth_level_data <- read.csv("data/SRP472645/SRP472645_CpGencode_meth_level.csv",row.names = 1)
SRP472645_GpC_meth_level_data <- read.csv("data/SRP472645/SRP472645_GpCencode_meth_level.csv",row.names = 1)
...
SRP472645_CpG_mofa <- create_mofa(mofa_list,group = SRP472645_Epis_sample_filter_choose$group1)

ModelOptions <- get_default_model_options(SRP472645_CpG_mofa)
TrainOptions <- get_default_training_options(SRP472645_CpG_mofa)
DataOptions <- get_default_data_options(SRP472645_CpG_mofa)

TrainOptions$convergence_mode <- "slow"
DataOptions$scale_views <- TRUE
DataOptions$center_groups <- TRUE

SRP472645_CpG_mofa <- prepare_mofa(SRP472645_CpG_mofa,
                                   model_options = ModelOptions,
                                   training_options = TrainOptions,
                                   data_options = DataOptions)

SRP472645_CpG_mofa <- run_mofa(SRP472645_CpG_mofa)
...
SRP472645_CpG_DEG_choose_chr_gene <- inner_join(SRP472645_CpG_DEG_choose_chr, mm10_enhancers_paste, by = "chr") %>%
...
SRP472645_CpG_methlevel_choose_colmean <- colMeans(SRP472645_CpG_methlevel_choose,na.rm = T)
