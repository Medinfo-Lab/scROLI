...
# save.image("SRP151137_plot/Gene_ALL.RData")
...
GRCm38_data_paste$geneid <- remove_after_last_dot(GRCm38_data_paste$gene)
...
# save.image("SRP151137_plot/Gene_ALL_Means.RData")
load("SRP151137_plot/Gene_ALL_Means.RData")
...
# write.csv(GRCm38_data_paste,"a.csv")
SRP151137_CpG_DEG_geneid <- SRP151137_CpG_DEG %>%
  left_join(GRCm38_data_paste, by = "chr")


SRP151137_CpG_DEG_P <- SRP151137_CpG_DEG_geneid %>%
  filter(P.value < 0.05)
...
SRP151137_CpG_DEG_choose_chr_gene <- inner_join(SRP151137_CpG_DEG_choose_chr, GRCm38_data_paste, by = "chr") %>%
...
ego <- enrichGO(gene = SRP151137_CpG_DEG_P$geneid,
                keyType = "ENSEMBL",
                OrgDb = org.Mm.eg.db,
